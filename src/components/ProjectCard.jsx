...
// export default function ProjectCard({ title, description, tech, imgUrl, githubUrl, liveUrl }) {
//   return (
//     <motion.div
//       whileHover={{ scale: 1.03 }}
//       transition={{ duration: 0.3 }}
//       className="relative bg-white/5 border border-white/10 backdrop-blur-md rounded-2xl shadow-lg overflow-hidden group"
//     >
//       {/* Project Image */}
